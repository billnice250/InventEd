            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-text">
                        ...
                        <p class="intro">This is an online platform intended to bring together young brilliant minds acorss the African continent.  </p>
                        <ul class="about-list">
                            <li>
    ...
    <div id="tf-clients" class="text-center">
        <div class="overlay">
            <div class="container">
                ...
                <div id="clients" class="owl-carousel owl-theme" style="margin-left:200px">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div id="testimonial" class="owl-carousel owl-theme">
                            <div class="item">
                                ...
                                <p><strong>Teta Vanessa</strong>, InventEd Inc.</p>
                            </div>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <form>
                        ...
                        <button type="submit" class="btn tf-btn btn-opaque">Submit</button>
                    </form>
